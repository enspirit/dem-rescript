...
data_format: "js"
  ...
  color: green;
      ...
      let partials = Js.Dict.fromList(list{
        ("another_subsection", another_subsection),
      ...
      test("#partials_dependencies is empty when there is no partial call", () =>
        expect(App.partials_dependencies(text)) |> toBe(list{})
      )

      test("#instantiate_body works with default when empty arguments given", () =>
        expect(App.instantiate_body(None, None, None)) |> toBe("")
      )

      test("#instantiate_body works with default when no body given", () =>
        expect(App.instantiate_body(None, Some(json_data), None)) |> toBe("")
      )
...
`)
  ...
  <body>
    <article id="rescript-executes-mustache-using-json-data">
      <h1>ReScript executes Mustache using json data.</h1>
    </article>
  </body>
</html>
`)
  ...
  <body>
    <article id="rescript-executes-mustache-using-yaml-data">
      <h1>ReScript executes Mustache using yaml data.</h1>
    </article>
  </body>
</html>
`)
...
`)
  ...
  <body>
    <article id="rescript-executes-mustache-using-js-data">
      <h1>ReScript executes Mustache using js data.</h1>
    </article>
  </body>
</html>
`)
  ...
  <body>
    <article id="rescript-executes-mustache-using-complex-js-data">
      <h1>ReScript executes Mustache using complex js data.</h1>
    </article>
  </body>
</html>
`)
